...
(
    pokedex_number  int AUTO_INCREMENT,
...
INSERT INTO pokemon (pokedex_number, `name`, speed, special_defence, special_attack, defence, attack, hp, primary_type,
                     secondary_type)
...
SELECT primary_type AS G, AVG(speed)
FROM pokemon
GROUP BY primary_type
